...
document.getElementsByClassName("adicionar")[0].addEventListener("click", encontrarUsuario())
document.getElementsByClassName("reduzir")[0].addEventListener("click", encontrarUsuario())
...
function capturarSoma() {
    ...
    const NewStarUser = {...userLogado, Estrelas:somaTotal} 
